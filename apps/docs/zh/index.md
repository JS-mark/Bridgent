...
hero:
  ...
  tagline: 把你已有的 OpenAPI 规范、Prisma schema 与 Zod 函数转换为生产可用的 Model Context Protocol 服务器 —— 在 Claude Code、Codex、Cursor 与 Gemini CLI 中即刻可用。
  actions:
    - theme: brand
      text: 快速开始
...
features:
  - title: 一行命令,任意数据源
    details: OpenAPI 3.x、Prisma 6.x 与手写 Zod 工具已经发布。Drizzle、tRPC、GraphQL 是后续数据源规划。
  - title: stdio + HTTP
