...
- 试试已发布的数据源适配器:[OpenAPI](./from-openapi)、[Prisma](./from-prisma)、[Drizzle](./from-drizzle)、[tRPC](./from-trpc) 或 [Zod](./from-zod)
- 路线图:v0.4 聚焦 generated tool surfaces 的本地 policy enforcement;GraphQL 会等具体集成目标出现后再做
